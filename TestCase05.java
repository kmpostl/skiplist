...
public class TestCase05
{
	public static void main(String [] args)
	{
		...
		for (int i = 0; i < 10; i++)
		{
			...
			System.out.println("number of elements is "+ numElements + "\tcount is " + count);
			//System.out.println("height of list ==  " + skiplist.height() + "\theight of head is " + skiplist.head().height());
			//System.out.println("500 - count should be " + (numElements / 2 - count));
