...
public class TestCase11
{
	...
	public static void main(String [] args)
	{
		...
		System.out.println("Before.... Head height = " + skiplist.head().height() + "\tList height = " + skiplist.height());
		// Now delete one of those values at random.
		skiplist.delete(RNG.getRandomUnusedInteger());

		System.out.println("After.... Head height = " + skiplist.head().height() + "\tList height = " + skiplist.height());
